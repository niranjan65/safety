            ...
            <aside className="w-64 bg-[#16161a] border-r border-[#22222a] flex flex-col hidden md:flex">
                ...
                <nav className="flex-1 p-4 space-y-2">
                    ...
                    <Link
                        ...
                        className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-colors ${pathname.startsWith('/admin/categories') ? 'bg-accent-yellow/10 text-accent-yellow font-semibold' : 'text-text-secondary hover:bg-white/[0.04] hover:text-text-primary'
                            }`}
                    >
